...
class Actions:
    ...
    def getNoisyAction(action, possible_actions):
        r = random.random()
        if r < Actions.CORRECT_ACTION_PROB:
            return action
        else:
            return random.choice(possible_actions)
    getNoisyAction = staticmethod(getNoisyAction)
...
class Game:
    ...
    def run( self ):
        ...
        while not self.gameOver:
            ...
            # Execute the action
            action = Actions.getNoisyAction(action, self.state.getLegalActions())
